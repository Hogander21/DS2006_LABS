...
def player_names_function(number_of_players: int):
    '''
    Args: number_of_players: int
    For loop to obtain the player names
    
    return player_name: list
    '''
...
def scores_and_rolls(number_of_players: int):
    # Initialize scores and rolls
    '''
    Args: number_of_players: int
    For loop the apped the win to list 
    
    return: player_wins: list 
    '''
    for i in range(number_of_players):
...
def nested_list_rolls(number_of_players: int):
    '''
    Args: number_of_players: int
    For loop to create list for each player
    
    return: player_rolls_history: list 
    '''
    for i in range(number_of_players):
        
        player_rolls_history.append([])
    return player_rolls_history

# Repeats until the game is over 


def game_logic(number_of_players: list, player_rolls_history: list, gameover: bool, winning_score: int):
...
def save_output(number_of_players, player_rolls_history, round_number):
...
# Array storing the names of the players:
player_names = []
...
winning_score = int(input("What score should be the win at? i.e: 4: \n"))


# Functions to get the names, scores and rolls, create lists for each player
player_names_function(number_of_players)
scores_and_rolls(number_of_players)
nested_list_rolls(number_of_players)

while gameover is False:
    game_logic(number_of_players, player_rolls_history, gameover, winning_score)
    rounds += 1
    if rounds >= winning_score:
        break
    
save_output(number_of_players, player_rolls_history, rounds)
